...
SUPERSET_WEBSERVER_ADDRESS = 'http://superset-prod.rivigo.com'
...
DRUID_TZ = tz.gettz('Asia/Kolkata')
...
OAUTH_PROVIDERS = [
   {'name': 'azure', 'icon': 'fa-windows', 'token_key': 'access_token',
        'remote_app': {
            'consumer_key':'97c314d3-8bd5-41ea-b988-2b9d76040ff7',
            'consumer_secret':'vJL2fz3elGtB38CqBXenZX1zMGARp0j2qeX1x8s1xIY=',
            'base_url': 'https://login.microsoftonline.com/495d6a2a-42b4-489a-ba7c-cd7e933ec752/oauth2',
            'request_token_params': {
              'scope': 'email profile',
              'resource' : os.environ.get('97c314d3-8bd5-41ea-b988-2b9d76040ff7'),
            },
            'request_token_url': None,
            'access_token_url':'https://login.microsoftonline.com/495d6a2a-42b4-489a-ba7c-cd7e933ec752/oauth2/token',
    'authorize_url':'https://login.microsoftonline.com/495d6a2a-42b4-489a-ba7c-cd7e933ec752/oauth2/authorize'}
    }
...
SMTP_STARTTLS = True
SMTP_SSL = False
SMTP_USER = 'devops@rivigo.com'
SMTP_PORT = 587
SMTP_PASSWORD = 'Airtel@321'
SMTP_MAIL_FROM = 'devops@rivigo.com'
#EMAIL_NOTIFICATIONS = False  # all the emails are sent using dryrun
#SMTP_HOST = 'localhost'
#SMTP_STARTTLS = True
#SMTP_SSL = False
...
EMAIL_REPORT_FROM_ADDRESS = 'devops@rivigo.com'
#EMAIL_REPORT_FROM_ADDRESS = 'reports@superset.org'


# Send bcc of all reports to this address. Set to None to disable.
# This is useful for maintaining an audit trail of all email deliveries.
EMAIL_REPORT_BCC_ADDRESS = 'sourabh.kalal@rivigo.com'
...
WEBDRIVER_BASEURL = 'http://superset-prod.rivigo.com'
#WEBDRIVER_BASEURL = 'localhost:80'
